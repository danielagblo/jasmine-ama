        ...
        <div className="relative flex flex-col md:flex-row justify-between items-center gap-8 text-[11px] tracking-wide">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex gap-4 font-bold">
              <a href="https://instagram.com/jasmineama" className="hover:text-brand-accent transition-luxury">Instagram</a>
              <a href="https://youtube.com/@jasmineama" className="hover:text-brand-accent transition-luxury">YouTube</a>
              <a href="https://tiktok.com/@jasmineama" className="hover:text-brand-accent transition-luxury">TikTok</a>
            </div>
          </div>
        </div>
      </div>
