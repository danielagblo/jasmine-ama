          ...
          <div className="p-12 border-t border-foreground/5 bg-brand-slate/30">
             <div className="flex flex-col items-center gap-6">
                ...
                <div className="flex gap-10 text-brand-gold">
                  <a href="https://instagram.com/jasmineama" className="hover:text-brand-accent transition-luxury">
                  ...
                  <a href="https://youtube.com/@jasmineama" className="hover:text-brand-accent transition-luxury">
                    <svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <path d="M22.54 6.42a2.78 2.78 0 0 0-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 0 0-1.94 2A29 29 0 0 0 1 11.75a29 29 0 0 0 .46 5.33A2.78 2.78 0 0 0 3.4 19c1.72.46 8.6.46 8.6.46s6.88 0 8.6-.46a2.78 2.78 0 0 0 1.94-2 29 29 0 0 0 .46-5.25 29 29 0 0 0-.46-5.33z"></path>
                      <polygon points="9.75 15.02 15.5 11.75 9.75 8.48 9.75 15.02"></polygon>
                    </svg>
                  </a>
                  <a href="https://tiktok.com/@jasmineama" className="hover:text-brand-accent transition-luxury">
